...
File(source::Union{String, IO};
    ...
    strict::Bool=false,
    debug::Bool=false) =
    File(source, use_mmap, header, datarow, skipto, footerskip, limit, transpose, missingstrings, missingstring, delim, ignore_repeated_delimiters, quotechar, openquotechar, closequotechar, escapechar, dateformat, decimal, truestrings, falsestrings, types, typemap, allowmissing, categorical, strict, debug)
