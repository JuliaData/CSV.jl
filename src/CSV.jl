...
File(source::Union{String, IO};
    ...
    strict::Bool=false,
    debug::Bool=false) =
    File(source, use_mmap, header, normalizenames, datarow, skipto, footerskip, limit, transpose, comment, missingstrings, missingstring, delim, quotechar, openquotechar, closequotechar, escapechar, dateformat, decimal, truestrings, falsestrings, types, typemap, allowmissing, categorical, strict, debug)
