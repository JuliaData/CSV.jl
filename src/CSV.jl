...
* Parsing options:
  ...
  * `quotechar::Union{UInt8, Char}='"'`, `openquotechar`, `closequotechar`: character (or different start and end characters) that indicate a quoted field which may contain textual delimiters or newline characters
  * `escapechar::Union{UInt8, Char}='\\'`: character used to escape quote characters in a text field
  ...
  * `decimal::Union{UInt8, Char, Nothing}`: how decimals are separated in floats, i.e. `3.14` used '.', or `3,14` uses a comma ','
