...
function __init__()
    ...
    FUNCTIONMAP[Int64] = @cfunction(getsetInt!, Cvoid, (Vector{Int64}, Any, Cssize_t, Cssize_t))
    ...
    FUNCTIONMAP[WeakRefString{UInt8}] = @cfunction(getsetWeakRefString!, Cvoid, (StringVector{String}, Any, Cssize_t, Cssize_t))
