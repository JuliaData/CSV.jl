...
f = CSV.Source(joinpath(dir, "attenu.csv"), null="NA", rows_for_type_detect=200)
@test size(Data.schema(f)) == (182, 5)
@test Data.types(Data.schema(f)) == (Int, Float64, Union{Missings.Missing, WeakRefString{UInt8}}, Float64, Float64)
