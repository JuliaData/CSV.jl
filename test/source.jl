...
f = CSV.Source(joinpath(dir, "Fielding.csv"); types=Dict("GS"=>Union{Int, Missing},"PO"=>Union{Int, Missing},"A"=>Union{Int, Missing},"E"=>Union{Int, Missing},"DP"=>Union{Int, Missing},"PB"=>Union{Int, Missing},"InnOuts"=>Union{Int, Missing},"WP"=>Union{Int, Missing},"SB"=>Union{Int, Missing},"CS"=>Union{Int, Missing},"ZR"=>Union{Int, Missing}), allowmissing=:none)
@test size(Data.schema(f), 2) == 18
...
@test Data.types(Data.schema(f)) == (Union{CategoricalArrays.CategoricalString{UInt32}, Missings.Missing}, Union{Int64, Missings.Missing}, Union{Int64, Missings.Missing}, Union{CategoricalArrays.CategoricalString{UInt32}, Missings.Missing}, Union{CategoricalArrays.CategoricalString{UInt32}, Missings.Missing}, Union{CategoricalArrays.CategoricalString{UInt32}, Missings.Missing}, Union{Int64, Missings.Missing}, Union{Int64, Missings.Missing}, Union{Int64, Missings.Missing}, Union{Int64, Missings.Missing}, Union{Int64, Missings.Missing}, Union{Int64, Missings.Missing}, Union{Int64, Missings.Missing}, Union{Int64, Missings.Missing}, Union{Int64, Missings.Missing}, Union{Int64, Missings.Missing}, Union{Int64, Missings.Missing}, Union{Int64, Missings.Missing})
ds = CSV.read(f)
