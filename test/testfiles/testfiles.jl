...
testfiles = [
    ...
    ("double_quote_quotechar_and_escapechar.csv", (escapechar='"',),
        (24, 5),
        NamedTuple{(:APINo, :FileNo, :CurrentWellName, :LeaseName, :OriginalWellName),Tuple{Float64,Int64,String,String,WeakRefStrings.EscapeString{0x22,0x22,0x22}}},
